    ...
    <article className="grid max-w-3xl gap-10">
      ...
      <section className="grid gap-3">
        ...
        <p className="leading-relaxed">
          ...
          stay ungraded, including an amplifier signal with no boosts. They are never flipped into 100 STRONG.
        </p>
      ...
      <section className="grid gap-3">
        ...
        <p className="leading-relaxed text-ink-soft">
          ...
          organic reach stays ungraded. It is not shown as 100 STRONG. When the signal is graded, organic reach is 100 minus that signal.
        </p>
      </section>
